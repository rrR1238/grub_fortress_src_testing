...
// Funfact: UnlitGeneric was supposed to route to this Shader,
// but due to a crash in the ShaderAPI with constants >c31 DistanceAlpha had to be implemented on UnlitGeneric instead.
//==========================================================================//
// Shader Start LUX_DistanceAlpha_Unlit
//==========================================================================//
BEGIN_VS_SHADER(LUX_DistanceAlpha_Unlit, "A Shader for the 'Signed Distance Fields' Alpha Effect.\n" )
...
//		bool bHasVertexColor = HasFlag(MATERIAL_VAR_VERTEXCOLOR) || HasFlag(MATERIAL_VAR_VERTEXALPHA);
		...
		int nUserDataSize = bProjTex ? 4 : 0;
		pShaderShadow->VertexShaderVertexFormat(flags, nTexCoords, 0, nUserDataSize);
		...
		SET_STATIC_VERTEX_SHADER_COMBO(NORMALS, bProjTex);
...
//		pShaderAPI->GetDX9LightState(&LightState);
		...
		SET_DYNAMIC_PIXEL_SHADER_COMBO(LIGHTMAPPED_MODEL, 0);
