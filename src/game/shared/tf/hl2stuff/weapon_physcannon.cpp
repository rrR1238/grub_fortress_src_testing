...
class CWeaponPhysCannon : public CTFWeaponBaseGun
{
public:
	DECLARE_CLASS( CWeaponPhysCannon, CTFWeaponBaseGun);
...
bool CWeaponPhysCannon::AttachObject(CBaseEntity* pObject, const Vector& vPosition)
{
	...
	m_grabController.AttachEntity(pOwner, pObject, pPhysics, 0, vPosition, (!bKilledByGrab));
