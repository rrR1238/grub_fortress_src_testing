...
enum
{
	...
	MODE_SAPPER_ENGINEER,
};

enum
{
	TYPE_SAPPER_NORMAL = 0,
	TYPE_SAPPER_DISPENSER_OVERHEAL,
	TYPE_SAPPER_SENTRY_FIRERATE,
	TYPE_SAPPER_SENTRY_MINICRIT,
};
...
typedef enum
{
	...
	BUILDING_HUD_ALERT_UPGRADE_INSTALLED,
