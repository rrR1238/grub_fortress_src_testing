...
#define ARTILLERY_SENTRY_MODEL_PLACEMENT			"models/buildables/sentry1_blueprint.mdl"
#define ARTILLERY_SENTRY_MODEL_LEVEL_1			"models/buildables/artillery_sentry1.mdl"
#define ARTILLERY_SENTRY_MODEL_LEVEL_1_UPGRADE	"models/buildables/artillery_sentry1_heavy.mdl"
#define ARTILLERY_SENTRY_MODEL_LEVEL_2			"models/buildables/artillery_sentry2.mdl"
#define ARTILLERY_SENTRY_MODEL_LEVEL_2_UPGRADE	"models/buildables/artillery_sentry2_heavy.mdl"
#define ARTILLERY_SENTRY_MODEL_LEVEL_3			"models/buildables/artillery_sentry3.mdl"
#define ARTILLERY_SENTRY_MODEL_LEVEL_3_UPGRADE	"models/buildables/artillery_sentry3_heavy.mdl"

#define ARTILLERY_SENTRY_ROCKET_MODEL "models/buildables/artiller_sentry3_rockets.mdl"

#define SKIRMISHER_SENTRY_MODEL_PLACEMENT			"models/buildables/sentry1_blueprint.mdl"
#define SKIRMISHER_SENTRY_MODEL_LEVEL_1			"models/buildables/artillery_sentry1.mdl"
#define SKIRMISHER_SENTRY_MODEL_LEVEL_1_UPGRADE	"models/buildables/artillery_sentry1_heavy.mdl"
#define SKIRMISHER_SENTRY_MODEL_LEVEL_2			"models/buildables/artillery_sentry2.mdl"
#define SKIRMISHER_SENTRY_MODEL_LEVEL_2_UPGRADE	"models/buildables/artillery_sentry2_heavy.mdl"
#define SKIRMISHER_SENTRY_MODEL_LEVEL_3			"models/buildables/artillery_sentry3.mdl"
#define SKIRMISHER_SENTRY_MODEL_LEVEL_3_UPGRADE	"models/buildables/artillery_sentry3_heavy.mdl"
...
void CObjectSentrygun::Spawn()
{
	m_iPitchPoseParameter = -1;
	m_iYawPoseParameter = -1;
	//bool ArtillerySentry;
	//bool SkirmisherSentry;
	//CALL_ATTRIB_HOOK_INT_ON_OTHER(GetBuilder(), ArtillerySentry, mod_builds_artillery_setry);
	//CALL_ATTRIB_HOOK_INT_ON_OTHER(GetBuilder(), SkirmisherSentry, mod_builds_artillery_setry);
	//if (ArtillerySentry) {
	//	m_iSentryType = 1;
	//}
	//else if (SkirmisherSentry) {
	//	m_iSentryType = 2;
	//}
	//else {
	//	m_iSentryType.Set(0);
...
void CObjectSentrygun::SetStartBuildingModel( void )
{
	switch (GetSentryType()) {
	case 0:
		SetModel(SENTRY_MODEL_LEVEL_1_UPGRADE);
	case 1:
		SetModel(ARTILLERY_SENTRY_MODEL_LEVEL_1_UPGRADE);
	}
	SetModel(SENTRY_MODEL_LEVEL_1_UPGRADE);
	m_iState.Set( SENTRY_STATE_INACTIVE );
}
...
void CObjectSentrygun::OnGoActive( void )
{
	...
	case 0:
		...
		Msg("Normal sentry\n");
	case 1:
		SetModel(ARTILLERY_SENTRY_MODEL_LEVEL_1);
		Msg("Artillery sentry \n" + GetSentryType());
	}
	if ( IsMiniBuilding() )
	{
		SetBodygroup( FindBodygroupByName( "mini_sentry_light" ), 1 );
...
void CObjectSentrygun::Precache()
{
	...
	case 0:
		...
		PrecacheModel(SENTRY_ROCKET_MODEL);
	case 1:
		PrecacheModel(ARTILLERY_SENTRY_MODEL_PLACEMENT);

		iModelIndex = PrecacheModel(ARTILLERY_SENTRY_MODEL_LEVEL_1);
		PrecacheGibsForModel(iModelIndex);

		iModelIndex = PrecacheModel(ARTILLERY_SENTRY_MODEL_LEVEL_1_UPGRADE);
		PrecacheGibsForModel(iModelIndex);

		iModelIndex = PrecacheModel(ARTILLERY_SENTRY_MODEL_LEVEL_2);
		PrecacheGibsForModel(iModelIndex);

		iModelIndex = PrecacheModel(ARTILLERY_SENTRY_MODEL_LEVEL_2_UPGRADE);
		PrecacheGibsForModel(iModelIndex);

		iModelIndex = PrecacheModel(ARTILLERY_SENTRY_MODEL_LEVEL_3);
		PrecacheGibsForModel(iModelIndex);

		iModelIndex = PrecacheModel(ARTILLERY_SENTRY_MODEL_LEVEL_3_UPGRADE);
		PrecacheGibsForModel(iModelIndex);

		PrecacheModel(ARTILLERY_SENTRY_ROCKET_MODEL);
	}
	PrecacheModel( "models/effects/sentry1_muzzle/sentry1_muzzle.mdl" );
...
void CObjectSentrygun::StartUpgrading( void )
{
	...
	case 2:
		...
		case 0:
			SetModel(SENTRY_MODEL_LEVEL_2_UPGRADE);
		case 1:
			SetModel(ARTILLERY_SENTRY_MODEL_LEVEL_2_UPGRADE);
		}
		m_flHeavyBulletResist = SENTRYGUN_MINIGUN_RESIST_LVL_2;
		SetViewOffset( SENTRYGUN_EYE_OFFSET_LEVEL_2 );
		m_iMaxAmmoShells = SENTRYGUN_MAX_SHELLS_2 * flMaxAmmoMult;
...
void CObjectSentrygun::FinishUpgrading( void )
{
	...
	case 2:
		...
		case 0:
			SetModel(SENTRY_MODEL_LEVEL_2);
		case 1:
			SetModel(ARTILLERY_SENTRY_MODEL_LEVEL_2);
		}
		break;
	case 3:
		switch (GetSentryType()) {
		case 0:
			SetModel(SENTRY_MODEL_LEVEL_3);
		case 1:
			SetModel(ARTILLERY_SENTRY_MODEL_LEVEL_3);
		}
		break;
	default:
		Assert(0);
...
bool CObjectSentrygun::FireRocket()
{
	...
	if ( m_bPlayerControlled || (tr.m_pEnt && !tr.m_pEnt->IsWorld()) )
	{
		...
		VectorAngles( vecAimDir, angAimDir );
		CTFProjectile_SentryRocket* pProjectile = CTFProjectile_SentryRocket::Create(vecSrc, angAimDir, this, GetBuilder());
//		CTFGrenadePipebombProjectile* pProjectile = CTFGrenadePipebombProjectile::Create(vecSrc, angAimDir, this, GetBuilder());
		if ( pProjectile )
		{
			int iDamage = 100;
			CALL_ATTRIB_HOOK_INT_ON_OTHER( GetOwner(), iDamage, mult_engy_sentry_damage );
...
LINK_ENTITY_TO_CLASS(tf_projectile_sentryrocket_artillery, CTFProjectile_SentryRocket_Artillery);

IMPLEMENT_NETWORKCLASS_ALIASED(TFProjectile_SentryRocket_Artillery, DT_TFProjectile_SentryRocket_Artillery)

BEGIN_NETWORK_TABLE(CTFProjectile_SentryRocket_Artillery, DT_TFProjectile_SentryRocket_Artillery)
END_NETWORK_TABLE()
...
CTFProjectile_SentryRocket_Artillery* CTFProjectile_SentryRocket_Artillery::Create(const Vector& vecOrigin, const QAngle& vecAngles, CBaseEntity* pOwner, CBaseEntity* pScorer)
{
	CTFProjectile_SentryRocket_Artillery* pRocket = static_cast<CTFProjectile_SentryRocket_Artillery*>(CTFBaseRocket::Create(NULL, "tf_projectile_sentryrocket", vecOrigin, vecAngles, pOwner));
...
CTFProjectile_SentryRocket_Artillery::CTFProjectile_SentryRocket_Artillery()
{
	UseClientSideAnimation();
}
...
// Purpose:
//-----------------------------------------------------------------------------
void CTFProjectile_SentryRocket_Artillery::Spawn()
{
	BaseClass::Spawn();
	SetModel(ARTILLERY_SENTRY_ROCKET_MODEL);
	UTIL_SetSize(this, vec3_origin, vec3_origin);
